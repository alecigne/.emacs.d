...
Install the [[https://github.com/waymondo/apropospriate-theme][=apropospriate=]] themes if they're not installed.
...
I use [[https://github.com/guidoschmidt/circadian.el][=circadian.el=]] with these themes. If =calendar-longitude= and
=calendar-latitude= are set in the personal config, use sunrise and
sunset time to switch themes. Otherwise, use the time of day.
