 ...
 #+BEGIN_SRC emacs-lisp :tangle no :noweb-ref config
   (setq org-publish-project-alist
         `(("org-notes"
            ...
            :base-extension "org"
            :exclude "README.org" ; for Github
            :publishing-directory "~/pub/website/notes/"
            :recursive t
            :publishing-function org-html-publish-to-html
            :headline-levels 4
            :with-toc nil
            :section-numbers nil
            :html-head "<link rel=\"stylesheet\" type=\"text/css\" href=\"https://anthony.lecigne.net/style.css\"/>"
            :html-preamble swanemacs-org-mode-preamble)
           ("emacs-config"
            :base-directory ,user-emacs-directory
            :base-extension "org"
            :publishing-directory "~/pub/website/articles/emacs/"
            :recursive t
            :publishing-function org-html-publish-to-html
            :exclude "elpa"
            :with-toc nil
            ...
            :html-preamble swanemacs-org-mode-preamble)
           ("website-org"
            :base-directory "~/pub/website/"
            :base-extension "org"
            :exclude "README.org" ; for Github
            :publishing-directory "~/pub/website/"
            :recursive t
            :publishing-function org-html-publish-to-html
            :with-toc nil
            :section-numbers nil
            :html-head "<link rel=\"stylesheet\" type=\"text/css\" href=\"https://anthony.lecigne.net/style.css\"/>"
            :html-preamble swanemacs-org-mode-preamble)
           ("website" :components ("website-org" "org-notes" "emacs-config"))))

   (defun swanemacs-org-mode-preamble (options)
     (let ((file "~/pub/website/top-menu.html"))
       (org-babel-with-temp-filebuffer file (buffer-string))))
 #+END_SRC
