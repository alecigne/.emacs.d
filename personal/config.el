...
(cond ((equal alc-current-system "laptop-windows")
      ...
      ((equal alc-current-system "laptop-linux")
       (setq alc-root-dir "/media/storage/"))
      ((equal alc-current-system "pc-karine")
       (setq alc-root-dir "C:/Users/Karine/Desktop/alc/"))
      ((or (equal alc-current-system "unknown-windows-system")
           (equal alc-current-system "unknown-linux-system"))
       (setq alc-root-dir "~/alc/")
       (unless (file-exists-p alc-root-dir)
         (make-directory alc-root-dir))))
